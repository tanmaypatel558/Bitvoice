...
// Helper functions to manage orders
...
export function createOrder(orderData: Omit<Order, 'id' | 'createdAt' | 'estimatedDelivery' | 'status'>): Order {
...
export function filterOrders(filters: { status?: string; customerId?: string }): Order[] {
